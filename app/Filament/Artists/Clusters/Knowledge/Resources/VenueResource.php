...
namespace App\Filament\Artists\Clusters\Knowledge\Resources;

use App\Filament\Artists\Clusters\Knowledge\Resources\VenueResource\Pages;
...
class VenueResource extends Resource
{
    ...
    protected static ?string $cluster = \App\Filament\Artists\Clusters\Knowledge\Knowledge::class;
    ...
    {
        return $table
            ->recordUrl(fn (Venue $record): string => Pages\ViewVenue::getUrl(['record' => $record]))
            ->columns([
                Stack::make([
