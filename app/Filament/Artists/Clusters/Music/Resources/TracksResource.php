...
use App\Filament\Artists\Clusters\Music\Resources\TracksResource\Pages;
use App\Filament\Index\Services\Audio\AudioMetadataExtractor;
use App\Models\Song;
use App\Models\Team;
use App\Models\User;
                        ...
                        Grid::make(1)
                            ...
                            ->schema([
                                InfoListSection::make('Audio')
                                    ->schema([
                                        \App\Filament\Index\Components\Infolists\AudioEntry::make('song_file')
                                            ->label('Audio Preview'),
                                    ])
                                    ->columns(1),
