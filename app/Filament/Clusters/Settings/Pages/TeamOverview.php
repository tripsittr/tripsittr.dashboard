...
class TeamOverview extends Page implements Forms\Contracts\HasForms, Tables\Contracts\HasTable
{
    ...
    protected static string $view = 'filament.settings.team.profile-members';
        ...
        return $table
            ...
            ->actions([
                Action::make('manage')
                    ...
                    ->url(fn ($record) => \App\Filament\Clusters\Settings\Pages\ManageMember::getUrl(['member' => $record]))
                    ->openUrlInNewTab(),
                Action::make('remove')
                    ->label('Remove')
